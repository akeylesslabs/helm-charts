...
| `dispatcher.config.allowedBastionUrls`                | List of the URLs that will be considered valid for redirection to this bastion (security measure to prevent Open Redirect) | `[]`                       |