...
| `dispatcher.config.allowedBastionUrls`                | Comma separated list of the URLs that will be considered valid for redirection to this bastion (security measure to prevent Open Redirect) | `[]`                       |