...
| `privilegedAccess.existingSecretNames.access`     | An existing secret that will hold both accessKey and accessID an example with the structure can be found in the value file                                                      | `[]`                       |
