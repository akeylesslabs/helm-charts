...
*/}}
{{- define "akeyless-ssh-proxy.name" -}}
...
*/}}
{{- define "akeyless-ssh-proxy.fullname" -}}
...
*/}}
{{- define "akeyless-ssh-proxy.chart" -}}
...
Common labels
*/}}
{{- define "akeyless-ssh-proxy.labels" -}}
helm.sh/chart: {{ include "akeyless-ssh-proxy.chart" . }}
{{ include "akeyless-ssh-proxy.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "akeyless-ssh-proxy.selectorLabels" -}}
app.kubernetes.io/name: {{ include "akeyless-ssh-proxy.name" . }}
...
*/}}
{{- define "akeyless-ssh-proxy.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "akeyless-ssh-proxy.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
...
{{ default (include "akeyless-zero-trust-bastion.fullname" .) .Values.ztbConfig.config.rdpRecord.existingSecret }}
{{- end -}}