...
{{- define "cacheEnableTls" -}}
{{ and .Values.cache .Values.cache.tls (or .Values.cache.tls.autoGenerated (ne .Values.cache.tls.existingSecretName "")) }}
{{- end -}}

{{- define "generatedCacheTlsSecretName" -}}
{{- printf "%s-crt" (include "akeyless-api-gw.fullname" .) }}
{{- end -}}

{{- define "cacheTlsSecretName" -}}
{{ ternary .Values.cache.tls.existingSecretName (include "generatedCacheTlsSecretName" .) (ne .Values.cache.tls.existingSecretName "") }}
{{- end -}}
...
{{- printf "%s:6379" (include "cacheAddress" . ) }}
{{- end -}}